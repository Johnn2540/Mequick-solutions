// Hand-apply script — see prisma/migrations/20260720090000_audit_log_module_status/apply.js
// for why `prisma migrate dev`/`deploy` are not used against this database.
// Runs migration.sql in one transaction via `pg`, then records it in
// `_prisma_migrations`.
//
// Usage: node prisma/migrations/20260720100000_add_product_show_price/apply.js
...
const MIGRATION_NAME = '20260720100000_add_product_show_price';
